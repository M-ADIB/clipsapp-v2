...
*Source of truth: 117 user-answered clarifications + live codebase audit (~70 routes, 121 edge functions, 132 database tables)*
...
*End of PRD. Total scope: 9 identities, ~70 routes, 132 tables, 121 edge functions, 11 modular admin surfaces, 14 integrations, 23 acceptance criteria.*
