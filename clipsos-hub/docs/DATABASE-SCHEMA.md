...
> **Direction, not copy-paste.** This document is a faithful export of the _current_ schema (`129` tables, `14` enums, `9` storage buckets, ~120 edge functions). Use it to design the rebuild — many tables will be renamed, merged, or dropped per the PRD. Rebuild guidance is called out inline with 🔄 / 🗑️ / ➕ markers.
...
_Tables not present in current DB (skipped): `metric_card_preferences`_
...
_End of Database Schema Reference. Companion to PRD.md and PERMISSIONS-MATRIX.md._
