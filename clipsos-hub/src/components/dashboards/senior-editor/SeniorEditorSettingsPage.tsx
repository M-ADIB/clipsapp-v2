/**
 * SeniorEditorSettingsPage — Senior Editor > Settings
 *
...
export function SeniorEditorSettingsPage() {
        ...
        <div className="rounded-xl border border-border bg-surface-card p-4 md:p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 rounded-lg bg-surface-raised px-3 py-2">
              ...
              <span className="text-xs font-medium text-foreground-muted">Role: Senior Editor</span>
            </div>
          </div>
        </div>
