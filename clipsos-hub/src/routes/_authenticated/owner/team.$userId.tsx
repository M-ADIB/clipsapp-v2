/**
 * /owner/team/:userId — Team member profile page.
 *
...
export const Route = createFileRoute("/_authenticated/owner/team/$userId")({
  component: OwnerTeamMemberPage,
});

function OwnerTeamMemberPage() {
